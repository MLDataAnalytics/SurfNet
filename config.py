...
def load_config():
    ...
    # args
    parser = argparse.ArgumentParser(description="SurfNN")
    
    # data
    parser.add_argument('--data_path', default="/Documents/", type=str, help="path of the dataset")
    ...
    parser.add_argument('--n_epoch', default=1000, type=int, help="total training epochs")
    parser.add_argument('--ckpts_interval', default=20, type=int, help="save checkpoints after each n epoch")
